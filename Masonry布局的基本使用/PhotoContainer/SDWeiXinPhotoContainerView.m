...
@property (nonatomic, assign) CGFloat img_hight;
...
#pragma mark=======本地图片
//- (void)setPicPathArray:(NSArray *)picPathStringsArray
- (void)setPicPathStringsArray:(NSArray *)picPathStringsArray
{
    _picPathStringsArray = picPathStringsArray;
...
- (CGSize)sizeWithimage{
     return CGSizeMake(self.img_width, self.img_hight);
}
